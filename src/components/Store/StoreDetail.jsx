    ...
    <div className="max-w-4xl mx-auto py-8 px-2">
      ...
      <div className="flex flex-col md:flex-row gap-8 mb-10">
        ...
        <div className="flex-1 flex justify-center items-center">
          <div className="w-[424px] h-[320px] bg-gray-200 rounded-lg overflow-hidden flex items-center justify-center">
        ...
        <div className="flex-1 flex flex-col gap-4 justify-center text-base">
          ...
          <div className="flex gap-2 flex-wrap">
            <span className="bg-orange-100 text-orange-900 px-2 py-1 rounded-full text-xs">
      ...
      <div className="flex justify-center mb-12">
        <button
          onClick={() => navi(`/reservation/${storeNo}`)}
